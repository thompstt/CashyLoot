...
resource "aws_secretsmanager_secret" "db_credentials" {
  # Name is auto-generated by RDS (contains "!" which Terraform's validation rejects).
  # Omitted here — the imported state tracks the real name. ignore_changes prevents drift.
  lifecycle {
    ignore_changes = all
  }
}
